...
export class BasketService {
  ...
  getBasket(username: string){
    return this.http.get<IBasket>(this.baseUrl+'/Basket/GetBasket/bane').subscribe({
  ...
  private createBasket(): Basket {
    ...
    localStorage.setItem('basket_username', 'bane'); //TODO: rahul can be replaced with LoggedIn User
    return basket;
  }
